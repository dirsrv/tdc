...
var TodoService = (function () {
    ...
    TodoService.prototype.deleteTodo = function (todoId) {
        var URI = this.apiurl + "/todos/" + todoId;
    ...
    TodoService.prototype.jwt = function () {
    ...
    TodoService.prototype.userid = function () {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        if (currentUser) {
...
var UserService = (function () {
    ...
    UserService.prototype.getAll = function () {
        return this.http.get(this.apiurl + '/users', this.jwt()).map(function (response) { return response.json(); });
    };
    UserService.prototype.getById = function (id) {
        return this.http.get(this.apiurl + '/users/' + id, this.jwt()).map(function (response) { return response.json(); });
    };
    UserService.prototype.create = function (user) {
        //default role assigned
        user.role = "BASE";
        return this.http.post(this.apiurl + '/users', user, this.jwt()).map(function (response) { return response.json(); });
    };
    UserService.prototype.update = function (user) {
        return this.http.put(this.apiurl + '/users/' + user.id, user, this.jwt()).map(function (response) { return response.json(); });
    };
    UserService.prototype.delete = function (id) {
        return this.http.delete(this.apiurl + '/users/' + id, this.jwt()).map(function (response) { return response.json(); });
    };
    // private helper methods
    //append jwt token to protected resources calls
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_todo_service__ = __webpack_require__("../../../../../src/app/_services/todo.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AddTodoComponent = (function () {
    function AddTodoComponent(todoServ) {
        this.todoServ = todoServ;
        this.addTodo = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    }
...
module.exports = "<!-- main app container -->\n<div class=\"jumbotron\">\n   \n\n<div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-xs-12\">\n                    <alert></alert>\n                    <router-outlet></router-outlet>\n            </div>\n        </div>\n    </div>\n\n</div>\n<!-- credits -->\n<div class=\"text-center\">\n    <p>\n        <a href=\"http://www.oracle.com\" target=\"_top\">Sample Angular / Node.js / Oracle app</a>\n    </p>\n</div>\n\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__view_todo_view_todo_component__ = __webpack_require__("../../../../../src/app/view-todo/view-todo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__add_todo_add_todo_component__ = __webpack_require__("../../../../../src/app/add-todo/add-todo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_todo_service__ = __webpack_require__("../../../../../src/app/_services/todo.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__view_todo_view_todo_component__["a" /* ViewTodoComponent */],
            __WEBPACK_IMPORTED_MODULE_13__add_todo_add_todo_component__["a" /* AddTodoComponent */]
        ],
        providers: [
...
module.exports = "<div class=\"row\">\n        <div class=\"col-md-offset-2 col-md-8\">\n    <h1>Hi {{currentUser.name}} {{currentUser.surname}}!</h1>\n    <p>You've logged in successfully using your email: {{currentUser.email}}</p>\n   \n    <!--\n    <h3>All registered users:</h3>\n    <ul>\n        <li *ngFor=\"let user of users\">\n            {{user.username}} ({{user.firstName}} {{user.lastName}})\n            - <a (click)=\"deleteUser(user.id)\">Delete</a>\n        </li>\n    </ul>\n-->\n\n    <p><a [routerLink]=\"['/login']\">Logout</a></p>\n\n</div>\n</div>\n<div class=\"row\">\n        <div class=\"col-md-offset-2 col-md-8\">\n                <h3>Your best todo list:</h3>\n                <app-view-todo> </app-view-todo>\n        </div>\n   </div>\n"
...
module.exports = "<div class=\"col-md-6 col-md-offset-3\">\n    <h2>Register</h2>\n    <form name=\"form\" (ngSubmit)=\"f.form.valid && register()\" #f=\"ngForm\" novalidate>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !email.valid }\">\n            <label for=\"name\">Name</label>\n            <input type=\"text\" class=\"form-control\" name=\"name\" [(ngModel)]=\"model.name\" #name=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !name.valid\" class=\"help-block\">First Name is required</div>\n        </div>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !email.valid }\">\n            <label for=\"surname\">Surname</label>\n            <input type=\"text\" class=\"form-control\" name=\"surname\" [(ngModel)]=\"model.surname\" #surname=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !surname.valid\" class=\"help-block\">Last Name is required</div>\n        </div>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !email.valid }\">\n            <label for=\"email\">Email</label>\n            <input type=\"text\" class=\"form-control\" name=\"email\" [(ngModel)]=\"model.email\" #email=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !email.valid\" class=\"help-block\">Email is required</div>\n        </div>\n        <div class=\"form-group\" [ngClass]=\"{ 'has-error': f.submitted && !password.valid }\">\n            <label for=\"password\">Password</label>\n            <input type=\"password\" class=\"form-control\" name=\"password\" [(ngModel)]=\"model.password\" #password=\"ngModel\" required />\n            <div *ngIf=\"f.submitted && !password.valid\" class=\"help-block\">Password is required</div>\n        </div>\n        <div class=\"form-group\">\n            <button [disabled]=\"loading\" class=\"btn btn-primary\">Register</button>\n            <img *ngIf=\"loading\" src=\"data:image/gif;base64,\" />\n            <a [routerLink]=\"['/login']\" class=\"btn btn-link\">Cancel</a>\n        </div>\n    </form>\n</div>\n"
